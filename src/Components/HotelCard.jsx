...
export default function HotelCard({ hotelId = 0, hotelName = 'N/A', location = 'N/A', city = 'N/A', viewMore = false, price, booking = false, essentials = [], policies = [], detailsLoading = true }) {
